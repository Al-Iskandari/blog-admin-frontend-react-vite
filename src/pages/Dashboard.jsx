        ...
        <div className="content-wrapper">
            <div className="row">
                ...
                <div className="row">
                    ...
                    <h6 className="font-weight-normal mb-0">May your day will be great today! You have <span className="text-primary">3 unread alerts!</span></h6>
                    </div>
                    ...
                    <div className="justify-content-end d-flex">
                        ...
                        <button className="btn btn-sm btn-light bg-white dropdown-toggle" type="button" id="dropdownMenuDate2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            <i className="mdi mdi-calendar" /> Today (30 Jan 2025)
                        </button>
            ...
            <div className="row">
                ...
                <div className="card tale-bg">
                    ...
                    <div className="weather-info">
                        ...
                        <div className="ml-2">
                            <h4 className="location font-weight-normal">Tg. Balai Karimun</h4>
                ...
                <div className="row">
                    ...
                    <div className="card card-dark-blue">
                        <div className="card-body">
                        <p className="mb-4">Ayuna Construction</p>
                ...
                <div className="row">
                    ...
                    <div className="card card-light-blue">
                        <div className="card-body">
                        <p className="mb-4">Ayuna Digital</p>
                    ...
                    <div className="card card-light-danger">
                        <div className="card-body">
                        <p className="mb-4">Ayuna Jastip</p>
